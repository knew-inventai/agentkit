...
> **參考文獻：** [Claude Code — Plugins](https://code.claude.com/docs/zh-TW/plugins) · [Codex — Plugins](https://developers.openai.com/codex/plugins) · [完整參考文獻列表](/agentkit/docs?page=references)
