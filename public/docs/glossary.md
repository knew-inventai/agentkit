...
**參考：** [套件類型 — Skill](/agentkit/docs?page=types/skill)
...
**參考：** [套件類型 — Agent](/agentkit/docs?page=types/agent)
...
**參考：** [套件類型 — MCP Server](/agentkit/docs?page=types/mcp)
...
**參考：** [套件類型 — Plugin](/agentkit/docs?page=types/plugin)
...
> **參見：** [參考文獻](/agentkit/docs?page=references)
